			...
			$.fn.inputNumber = function() {
				...
				matchStep = function(value, min, max, step) {
					...
					if (step == null) {
						...
						if (raisedMod === 0) {
							...
							if (((raisedStepUp / raiseTo) > max)
									|| ((raisedValue - raisedStepDown) < (raisedStepUp - raisedValue))) {
				...
				increment = function(elem) {
					...
					if (!$(elem).is(":disabled")) {
						...
						raiseTo = Math.pow(10, Math.max(extractNumDecimalDigits(params['val']),
								extractNumDecimalDigits(params['step'])));
				...
				$(this)
						...
						.each(
								function() {
									...
									$elem.on({
										...
										keypress : function(e) {
											...
											if (e.keyCode === 38) {
												...
												decrement(this);
											} else if (((_ref = e.keyCode) !== 8 && _ref !== 9 && _ref !== 35 && _ref !== 36
													&& _ref !== 37 && _ref !== 39)
													&& ((_ref1 = e.which) !== 45 && _ref1 !== 46 && _ref1 !== 48 && _ref1 !== 49
															&& _ref1 !== 50 && _ref1 !== 51 && _ref1 !== 52 && _ref1 !== 53
															&& _ref1 !== 54 && _ref1 !== 55 && _ref1 !== 56 && _ref1 !== 57)) {
												e.preventDefault();
											}
											return null;
										},
									...
									if ((typeof WebKitMutationObserver !== "undefined" && WebKitMutationObserver !== null)
										...
										attrObserver = (typeof WebKitMutationObserver !== "undefined" && WebKitMutationObserver !== null) ? new WebKitMutationObserver(
												attrMutationCallback)
												: ((typeof MutationObserver !== "undefined" && MutationObserver !== null) ? new MutationObserver(
														attrMutationCallback)
														: null);
										...
										$elem.on("DOMAttrModified", function(evt) {
											if (evt.originalEvent.attrName === "class") {
												$(btnContainer).removeClass(evt.originalEvent.prevValue).addClass(
														evt.originalEvent.newValue);
